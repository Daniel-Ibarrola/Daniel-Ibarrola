...
Senior backend engineer with a track record of inheriting slow or unreliable systems and making them fast and dependable — DynamoDB queries that took API responses from 29s to seconds, CI pipelines made faster and more secure, real-time data infrastructure for thousands of seismic sensors. Currently building CI tooling for Google's JAX and XLA. Six years of production experience in Python, Node.js, PostgreSQL, AWS, and Terraform.
